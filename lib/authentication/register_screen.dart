...
// GET CURENT POSITION
  ...
  Future saveDataToFirestore(User currentUser) async {
    FirebaseFirestore.instance.collection('admins').doc(currentUser.uid).set({
      ...
      'adminAvatarUrl': adminImageUrl,
      'adminPhone': phoneController.text.trim(),
      'adminAddress': locationController.text.trim(),
      'adminSatus': 'approved',
      'adminEarnings': 0.0,
    ...
    await sharedPreferences!.setString('photoUrl', adminImageUrl);
    //await sharedPreferences!.setString('uid', currentUser.uid);
  }
